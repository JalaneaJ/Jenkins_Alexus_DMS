...
public class ConceptBreakdownToolUI extends JFrame {
    ...
    public ConceptBreakdownToolUI(DatabaseManager dbManager) {
        ...
        this.mainWindow = new MainApplicationWindow(dbManager, this);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ConceptBreakdownToolUI frame = new ConceptBreakdownToolUI(dbManager); // Initialize ConceptBreakdownToolUI here
            MainApplicationWindow mainWindow = new MainApplicationWindow(dbManager, frame); // Pass frame reference here
            frame.setMainWindow(mainWindow); // Set the mainWindow in the frame, if necessary
