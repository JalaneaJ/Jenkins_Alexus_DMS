            ...
            switch (type) {
                ...
                case "component":
                    ...
                    if (concept != null) {
                        ...
                        int newComponentId = dbManager.generateNewComponentId();
                        // Adding the component with the generated ID and linking it to the concept
        ...
        try {
            switch (type) {
                case "concept":
                    ...
                    break;
                case "component":
                    // Adjusted to use component Topic for removal
